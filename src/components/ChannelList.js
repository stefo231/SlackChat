    ...
    function handleEvents(e) {
      if (e.type === 'message.new') {
        ...
        if (oneOnOneConversations >= 0) {
          ...
          oneOnOneConversations.splice(oneOnOneConversations, 1);
    ...
    <SafeAreaView>
      <View style={styles.container}>
        ...
        <SectionList
          ...
          sections={[
            {title: 'Unread', id: 'unread', data: unreadChannels || []},
            {title: 'Channels', data: readChannels || []},
            {title: 'Direct Messages', data: oneOnOneConversations || []},
          ]}
          ...
          renderSectionHeader={({section: {title}}) => (
            <View style={styles.groupTitleContainer}>
              <Text style={styles.grouptTitle}>{title}</Text>
            </View>
          )}
        />
      </View>
